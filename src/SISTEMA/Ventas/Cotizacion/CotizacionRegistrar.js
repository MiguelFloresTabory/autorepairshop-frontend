...
import { ValidarGrabarCotizacion, schemaCotizacion } from './ValidacionesCotizacion';
...
export default function CotizacionRegistrar({ setPillActive, listaProductos, setListaProductos, objEdicion, setObjEdicion, estadoActualizo, setEstadoActualizo }) {
  ...
  const onSubmit = async (data) => {
    ...
    if (Object.keys(objEdicion).length > 0) {
      ...
      if (ValidarGrabarCotizacion(datos, listaProductos, objCliente)) {
            ...
            <Row>
              <Col sm='4'>
                <Row className='mb-1'>
                  ...
                  <InputAutocompleteCliente setDescripcion={setDescripcionAutoComplete} descripcion={descripcionAutoComplete} setClientSelect={setObjCliente} clienteSelect={objCliente} classname={"col col-sm-8 col-md-8"} />
                </Row>
              </Col>
              <Col sm='4'>
                <Row className='mb-1'>
