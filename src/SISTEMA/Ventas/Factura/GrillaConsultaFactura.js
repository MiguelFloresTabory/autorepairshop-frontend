...
export default function GrillaConsultaFactura({ ListaData }) {
...
function BotonesGrilla({row}) {
  ...
  return (
    <div className='d-flex'>
      <Link to="#" id="anular" onClick={() => AnularFactura(row.codDocVenta)}>
        <Trash size={24} color='red' />
        <UncontrolledTooltip target="anular">Anular Registro</UncontrolledTooltip>
      </Link>
      <Link to="#" id="editar" onClick={() => EditarFactura(row.codDocVenta)}>
        <Edit size={24} />
