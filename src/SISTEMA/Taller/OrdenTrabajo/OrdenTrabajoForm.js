...
import OrdenTrabajoRegistrar from './OrdenTrabajoRegistrar'
import OrdenTrabajoConsulta from './OrdenTrabajoConsulta'
// import OrdenTrabajoConsulta from './OrdenTrabajoConsulta'
...
export default function OrdenTrabajoForm ()  {
    ...
    return(
        ...
        <h5 className='mt-0 mb-1' style={{paddingLeft: "15px"}} >ORDEN TRABAJO</h5>
        <Row>
          <Col md='10'>
            <Card >
              <CardHeader>
              ...
              <CardBody>
                <TabContent activeTab={activePill}>
                  <TabPane tabId='1'>
                  <OrdenTrabajoRegistrar setPillActive={setPillActive}  objEdicion={objEdicion}  setObjEdicion={setObjEdicion} listaProductos={listaProductos} 
                   setListaProductos={setListaProductos}  estadoActualizo={estadoActualizo} setEstadoActualizo={setEstadoActualizo} />
                  </TabPane>
                  <TabPane tabId='2'>
                  <OrdenTrabajoConsulta setObjEdicion={setObjEdicion}  objEdicion={objEdicion}  listaProductos={listaProductos} 
