...
export const OrdenTrabajoPdf = ({ ObjetoData }) => {
...
const Objs = {
  ...
  ordenTrabajosDets: "[{\"codOrdenTrabajoDet\":76,\"codOrdenTrabajo\":74,\"cantidad\":8.000000,\"precio\":350.000000,\"importe\":2800.000000000000,\"descripcion\":\"Llantas Hankook\",\"codigoAlternativo\":\"A00006\",\"codigoProducto\":\"GGRT2\",\"codProducto\":6,\"marca\":\"HINO\",\"codTipoProducto\":1},{\"codOrdenTrabajoDet\":77,\"codOrdenTrabajo\":74,\"cantidad\":10.000000,\"precio\":250.000000,\"importe\":2500.000000000000,\"descripcion\":\"rines\",\"codigoAlternativo\":\"A00009\",\"codigoProducto\":\"R44GF1\",\"codProducto\":9,\"marca\":\"VOLDSWAGEN\",\"codTipoProducto\":1}]",
  emision: "19/07/2023",
  ...
  return (
    <View style={stylesHS.page} >
      <View style={stylesHS.column}>
        ...
        <Text style={stylesHS.label}>Ruc: {ObjetoData.clienteRuc}</Text>
       
      </View>
      <View style={stylesHS.column}>
        <Text style={stylesHS.label}>Forma Pago: {ObjetoData.formaPago}</Text>
        <Text style={stylesHS.label}></Text>
        <Text style={stylesHS.label}>Moneda: {ObjetoData.moneda}</Text>
       
      </View>
      <View style={stylesHS.column}>
        <Text style={stylesHS.label}>Placa: {ObjetoData.placa}</Text>
        <Text style={stylesHS.label}></Text>
        <Text style={stylesHS.label}></Text>
      </View>
      ...
      <View style={stylesHS.column}>
      <Text style={stylesHS.label}>Doc: {ObjetoData.tipoDocumento}</Text>
  </View> : <View></View>*/}

       <View style={stylesHS.column2}>
        <Text style={stylesHS.label}>Mecanicos: {ObjetoData.mecanicos}</Text>
      ...
      <View style={stylesTable.page}>
        <View style={stylesTable.section}>
          ...
          <View style={stylesTable.table}>
            ...
            {JSON.parse(ObjetoData.ordenTrabajosDets) ?
              JSON.parse(ObjetoData.ordenTrabajosDets)?.map((item) =>

                <View key={item.codOrdenTrabajoDet} style={stylesTable.tableRow}>
